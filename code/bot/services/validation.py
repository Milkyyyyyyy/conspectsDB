...
validators.add('theme',
    r'^[А-Яа-яЁёA-Za-z0-9\s\.\,\:\;\!\?\-–—\(\)"\'«»\/]{1,200}$',
    "<b>Некорректная тема.</b>\n"
    "Тема может содержать только <b>буквы (кириллица/латиница), цифры, пробелы и знаки препинания</b> (без эмодзи и прочих спецсимволов). Максимум 200 символов.\n")

validators.add('conspect_date',
    r'^(0[1-9]|[12][0-9]|3[01])\.(0[1-9]|1[0-2])\.(19|20)\d{2}$',
    "<b>Некорректная дата.</b>\n"
    "Ожидается формат <b>ДД.ММ.ГГГГ</b> (например: <i>05.09.2025</i>).")
